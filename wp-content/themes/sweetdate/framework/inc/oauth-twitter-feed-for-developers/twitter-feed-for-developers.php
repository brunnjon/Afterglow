...
function getTweets($count = 20, $username = false, $options = false) {
  ...
  $config['key'] = sq_option('tdf_consumer_key');
  $config['secret'] = sq_option('tdf_consumer_secret');
  $config['token'] = sq_option('tdf_access_token');
  $config['token_secret'] = sq_option('tdf_access_token_secret');
  $config['screenname'] = sq_option('tdf_user_timeline');
