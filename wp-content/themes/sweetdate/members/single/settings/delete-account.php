...
<?php get_template_part('page-parts/buddypress-before-wrap');?>
			...
			<div id="item-body" role="main">
				...
				<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
					...
					<div class="submit">
						<input type="submit" disabled="disabled" value="<?php _e( 'Delete Account', 'buddypress' ); ?>" id="delete-account-button" class="button small radius" name="delete-account-button" />
					</div>
    ...
    jQuery(document).ready(function() {
        jQuery("#delete-account-understand").change(function() {
