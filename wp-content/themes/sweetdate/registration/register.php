		...
		<div id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<div class="register-section six columns" id="basic-details-section">
					...
					<input type="password" name="signup_password" id="signup_password" value="<?php bp_signup_password_value(); ?>" />

					<label for="signup_password_confirm"><?php _e( 'Confirm Password', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?></label>
					<?php do_action( 'bp_signup_password_confirm_errors' ); ?>
					<input type="password" name="signup_password_confirm" id="signup_password_confirm" value="<?php bp_signup_password_confirm_value(); ?>" />
                    <br><br>
